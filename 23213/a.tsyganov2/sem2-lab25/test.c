...
int main(int argc, char **argv) {
	...
	unsigned long long nprod, ncons;
	queue q;
        int i;
	...
	nprod=strtoull(argv[1], (char**)NULL, 10);
	ncons=strtoull(argv[2], (char**)NULL, 10);
	...
	pthread_t producers[(size_t)nprod];
	pthread_t consumers[(size_t)ncons];
