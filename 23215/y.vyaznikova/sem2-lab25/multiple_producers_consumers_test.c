...
int main() {
    printf("=== Multiple Producers and Consumers Test ===\n\n");
    ...
    pthread_create(&prod2, NULL, producer, &q1);
    pthread_create(&cons1, NULL, consumer, &q1);
    pthread_create(&cons2, NULL, consumer, &q1);
    ...
    pthread_create(&new_prod1, NULL, producer, &q2);
    pthread_create(&new_prod2, NULL, producer, &q2);
    pthread_create(&new_cons1, NULL, consumer, &q2);
    pthread_create(&new_cons2, NULL, consumer, &q2);
